...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // Hide camera animation after scrolling past it
    const handleScroll = () => {
  ...
  const scrollToContent = () => {
    window.scrollTo({
      top: window.innerHeight * 3, // Scroll past the camera animation
      behavior: 'smooth'
    });
  };
  ...
  return (
    <>
      {showCamera && <CameraAnimation />}
      
      <div className="relative h-screen w-full overflow-hidden bg-navy mt-[200vh]">
        {/* Video Background */}
